function AptosLogo () {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="a" x="0px" y="0px" viewBox="0 0 479.3 481.2" className="w-6 h-6 fill-[black] dark:fill-[white] ml-2">
